    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-accent/5 items-center justify-center p-12">
        ...
        >
          ...
          <h2 className="font-serif text-2xl font-semibold mb-4">스타일을 선택하세요</h2>
          <p className="text-muted-foreground">
            한국 웨딩을 위해 디자인된 아름다운 템플릿에서 선택하세요. 모든 템플릿은 자유롭게 커스터마이징할 수 있습니다.
          </p>
        </motion.div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              ...
              <Label htmlFor="terms" className="text-sm text-muted-foreground leading-tight cursor-pointer">
                <Link href="/terms" className="text-foreground hover:underline">이용약관</Link>
                {' '}및{' '}
                <Link href="/privacy" className="text-foreground hover:underline">개인정보처리방침</Link>
                {'에 동의합니다'}
              </Label>
            </div>
