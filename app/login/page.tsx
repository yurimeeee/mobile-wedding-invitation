      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="font-serif text-2xl font-semibold mb-2">다시 오셨군요</h1>
              ...
              <div className="phone-screen aspect-[9/19.5] bg-gradient-to-b from-accent/10 to-white">
                <div className="p-4 text-center">
                  ...
                  <p className="font-serif text-[10px] text-muted-foreground">
                    {'서로 다른 두 사람이'}<br />{'사랑으로 하나가 되는 날'}
                  </p>
                </div>
              </div>
            </div>
          </div>
          <h2 className="font-serif text-2xl font-semibold mb-4">소중한 추억을 만들어요</h2>
          <p className="text-muted-foreground">
            하객들이 좋아할 아름다운 청첩장을 디자인하세요. 특별한 날을 세련되게 공유하세요.
          </p>
        </motion.div>
      </div>
    </div>
